...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { ,: @picture.,, comment: @picture.comment, image: @picture.image } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { ,: @picture.,, comment: @picture.comment, image: @picture.image } }
